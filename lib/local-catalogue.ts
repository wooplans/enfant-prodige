...
export const localCatalogue: BD[] = [
  ...
  },
  {
    ...
    prix: 9900,
    fraisLivraison: 1000,
    couverture: "/decouvre-les-metiers/cover.webp",
    galerie: [
      "/decouvre-les-metiers/cover.webp",
      "/decouvre-les-metiers/hero-discovery.webp",
      "/decouvre-les-metiers/hero-planning.webp",
      "/decouvre-les-metiers/hero-future.webp",
    ],
    nombrePages: 32,
    ageMin: 6,
    ageMax: 10,
