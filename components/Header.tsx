...
export default function Header() {
  ...
  return (
    <header className="bg-green-800 text-white shadow-lg">
      ...
      {/* Mobile nav */}
      {menuOpen && (
        <div className="md:hidden bg-green-900 px-4 py-3 flex flex-col gap-3 text-sm font-medium">
          <Link href="/" onClick={() => setMenuOpen(false)} className="hover:text-yellow-300">
            Accueil
          </Link>
          <Link
            href="/catalogue"
