...
export const metadata: Metadata = {
  ...
  description: "Contactez-nous pour commander vos BD ou pour toute question.",
};

export default function ContactPage() {
  const message = encodeURIComponent(
    "Bonjour ! J'ai une question concernant vos bandes dessinées."
  );
    ...
    <div className="max-w-2xl mx-auto px-4 py-16">
      <div className="text-center mb-12">
        ...
        <p className="text-gray-500">
          Une question ? Vous souhaitez commander ou simplement en savoir plus sur nos BD ?
      ...
      <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 mb-8 text-center">
        ...
        <p className="text-gray-500 text-sm mb-6">
          C'est le moyen le plus rapide pour passer commande ou obtenir une réponse.
          Disponible de <strong>8h à 20h</strong>, 7j/7.
        </p>
        <a
          href={whatsappUrl}
          target="_blank"
      ...
      <div className="space-y-4">
        ...
        {[
          {
            q: "Où livrez-vous ?",
            a: "Nous livrons partout au Cameroun : Douala, Yaoundé, Bafoussam, Garoua, et toutes les villes de province.",
          },
          {
            q: "Comment fonctionne le paiement ?",
            a: "Vous payez le prix de la BD + les frais de livraison directement au livreur à la réception. Aucun paiement en avance.",
          },
          {
            q: "Quel est le délai de livraison ?",
            a: "2 à 5 jours ouvrables selon votre localisation. Contactez-nous sur WhatsApp pour un délai précis.",
          },
          {
            q: "Puis-je commander plusieurs BD à la fois ?",
            a: "Oui ! Les frais de livraison sont forfaitaires, peu importe la quantité. Précisez-le dans votre message WhatsApp.",
          },
        ].map(({ q, a }) => (
          <details
            key={q}
